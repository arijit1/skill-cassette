...
test('README makes the next-step prompt obvious and keeps the repo sample secondary', () => {
  const readme = readText('README.md');

  assert.match(readme, /repo-owned handoff layer/i);
  assert.match(readme, /next-step prompt/i);
